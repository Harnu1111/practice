...
const Ecommerce = () => {
  ...
  return (
    <div className='mt-12'>
      ...
      <div className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-full w-full lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center'>
